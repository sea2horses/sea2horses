...
C, Rust, C#, Java, Kotlin, Python, TypeScript, React, Svelte, Go
<br><br>
Strong background in OOP due to my C# knowledge, have worked with frameworks like WPF and WinForms for Desktop Development.

Worked with Django on Python and Ktor in Kotlin. (And a little experience in Spring Boot)

Also Wails for Golang and Tauri for Rust.

NextJS & SvelteKit for Web Development along with npm, pnpm, shadcn/ui & tailwindcss.

Rust for CLI and TUI development.
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=c,rust,cs,java,kotlin,py,js,ts,react,svelte,nextjs,go,git,linux,neovim,tailwind,pnpm,vscode" />
</p>
